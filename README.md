...
[finding_donors.html](https://github.com/andigles/finding-donors-ml/blob/main/docs/index.html)
...
```bash
jupyter nbconvert --to html notebooks/finding_donors.ipynb --output ../docs/index.html
```
